...
def main():
    ...
    number3 = input("i need a number, any at all")
    time1 = input("i need a unit of time")
    ...
    time.sleep(2)
    print(name3 + ": ok, thanks ill probs be about " + number3 + " " + time1 + ", see ya then")
    time.sleep(2)
    print(name3 + ": bye")
    time.sleep(2)
    print(name1 + ": righty, see you then")
    time.sleep(2)
    print(name2 + " nods and leaves to get food")
    time.sleep(2)
    print(name2 + " returns with food")
    time.sleep(2)
    print(name1 + ": hey, foods here, nice")
    time.sleep(2)
    print(name2 + ": let us move these things gentlemen")
    time.sleep(2)
    print(name1 + " and " + name2 + " collect all the food and put them into storage")
    time.sleep(2)
